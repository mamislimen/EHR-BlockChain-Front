...
export default class physicalactivity extends Component {
  ...
  addPhysical() {
    ...
    fetch('http://34.247.209.188:3000/api/PatientAddPhysicalActivity', {
     method: 'POST',
      headers: {
...
fetch('http://34.247.209.188:3000/api/Patient/'+this.state.id).then(res=>res.json()).then(json=>{
 ...
 json.physicalActivity.forEach((nut)=> {
    ...
    fetch('http://34.247.209.188:3000/api/Patient/'+this.state.id, {
     ...
     fetch('http://34.247.209.188:3000/api/PhysicalActivity/'+physicalId, {
      method: 'DELETE',
...
this._refreshPhysical();
  ...
  updatePhysical() {
    ...
    fetch('http://34.247.209.188:3000/api/PhysicalActivity/'+this.state.editPhysicalData.physicalId, {
     method: 'PUT',
      headers: {
        'Accept': 'application/json',
      'Content-Type': 'application/json',
  ...
  _refreshPhysical() {
    ...
    .then(json => {
      ...
      json.physicalActivity.forEach(ph => {
        ...
        //console.log(num[1]);
        if(num[1]!='null'){
        fetch('http://34.247.209.188:3000/api/PhysicalActivity/'+num[1])
        .then(res2 => res2.json())
        .then(json2 => {
