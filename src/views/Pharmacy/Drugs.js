...
class Drugs extends Component{
  ...
  renderMyData(){
    fetch('http://b0e413f5.ngrok.io/Patient/1')
    ...
    fetch('http://b0e413f5.ngrok.io/Prescription')
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  findDrugById = (drugId, presId) => {
    fetch('http://b0e413f5.ngrok.io/Drug/'+drugId)
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  MannualfindInteraction = () => {
    ...
    fetch('http://b0e413f5.ngrok.io/verifyInteraction', {
      method: 'POST',
      headers: {
  ...
  findInteraction = (drugName, presId) => {
    ...
    fetch('http://b0e413f5.ngrok.io/api/verifyInteraction', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
      ...
      .then((responseJson) => {
        this.setState({ interaction : responseJson, });
        if (this.state.interaction.length === 0) {
          fetch('http://b0e413f5.ngrok.io/PharmacyAddDrugFromPrescription', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
