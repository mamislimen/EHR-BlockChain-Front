...
export default class nutrition extends Component {
  ...
  addNutrition() {
    ...
    fetch('http://34.247.209.188:3000/api/PatientAddNutrition', {
     method: 'POST',
      headers: {
...
fetch('http://34.247.209.188:3000/api/Patient/1').then(res=>res.json()).then(json=>{
 ...
 json.nutrition.forEach((nut)=> {
    ...
    fetch('http://34.247.209.188:3000/api/Patient/1', {
     ...
     fetch('http://34.247.209.188:3000/api/Nutrition/'+nutritionId, {
      method: 'DELETE',
...
this._refreshNutrition();
  ...
  updateNutrition() {
    ...
    fetch('http://34.247.209.188:3000/api/Nutrition/'+this.state.editNutritionData.nutritionId, {
     method: 'PUT',
      headers: {
        'Accept': 'application/json',
      'Content-Type': 'application/json',
  ...
  _refreshNutrition() {
    ...
    .then(json => {
      ...
      json.nutrition.forEach(nut => {
        ...
        //console.log(num[1]);
        if(num[1]!='null'){
        fetch('http://34.247.209.188:3000/api/Nutrition/'+num[1])
        .then(res2 => res2.json())
        .then(json2 => {
